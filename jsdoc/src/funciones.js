 ...
 * @param {number} a - The function `suma(a, b)` takes two parameters, `a` and `b`, and returns their sum when
 * the function is called.
 * @param {number} b - The parameter `b` in the `suma` function is the second number that will be added to the
 * first number `a`.
