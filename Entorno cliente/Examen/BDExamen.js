...
document.addEventListener("DOMContentLoaded", (e) => {
  ...
  function creaCard(element){
    ...
    //añadir evento onclick a cada uno de los articulos
    article.addEventListener("click", (e) =>{
      let artic = e.currentTarget;
      let titulo = document.querySelector("#articulos article div p:nth-child(1)").textContent;

      let obj = new Carrito (arrCarr);
    ...
    pDes.textContent = element.description;
    div.appendChild(pDes);

    let pPre = document.createElement("p");
    pPre.textContent = element.price;
    div.appendChild(pPre);

    let pRat = document.createElement("p");
    pRat.textContent = "Valoración: " + element.rating.rate + " Votos: " + element.rating.count;
    div.appendChild(pRat);

    fragmento.appendChild(article);
  }

  //funcion para recorrer el array y llamar a la funcion para crear las cartas
  ...
  function filtra(objFiltro){
    ...
    objFiltro.push(arrProd);

    return arrProd
  }

  //function para devolver las categorias de los productos
  ...
  class Carrito {
    ...
    dibujaCarrito(){
      ...
      let pTit = document.createElement("p");
      divCarrito.appendChild(pTit);
      
      pTit.textContent = "";
      pTit.textContent = this.articulos;
